	    ...
	    map：[
	       {
	          ...
	          list: [{
	              ...
	              'tel':'(010)63105191',
	              'opening':'10:00-22:00',
	              'rcv_url':'http://www.omegawatches.cn/cn/stores/countries/stores-details?country=446&city=%E5%8C%97%E4%BA%AC&storetype=1&sellwatches=1'
	            },
	            {
	              city:'北京',
	              'name':'北京当代商城',
